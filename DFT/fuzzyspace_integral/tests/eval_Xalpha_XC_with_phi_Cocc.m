function [XC, Exc] = eval_Xalpha_XC_with_phi(natom, nbf, phi, ipw, Cocc)
% Evaluate XC matrix using Xalpha functional and phi and Cocc matrix
% Input parameters:
%   nbf  : Total number of basis functions
%   phi  : Values of basis function at integral points
%   ipw  : Integral point weights
%   Cocc : Cocc * Cocc' == density matrix
% Output parameter:
